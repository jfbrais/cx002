...
public class LogParser {
	...
	public String file = "C:\\traffic.log";
	...
	public class aFrame extends JFrame {
		public aFrame() {
			super("Transax Technologies - Log Parser");
	...
	static class MyCellRenderer extends JPanel implements ListCellRenderer {
		JLabel lID, lYear, lMonth, lDay, lTime, lProtocol, lSourceIP, lDestIP,
				lSourcePort, lDestPort, lRule;
